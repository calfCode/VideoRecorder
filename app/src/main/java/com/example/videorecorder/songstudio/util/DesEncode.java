 ...
 * 
 */
package com.example.videorecorder.songstudio.util;
...
public class DesEncode {
	...
	private static String encode(String key, byte[] data) throws Exception {
		...
		try{
			...
			String encodeStr = com.example.videorecorder.songstudio.util.Base64.encode(bytes);
	...
	public static String decode(String key, String data) throws Exception {
		...
		try{
			...
			datas = decode(key, 
					com.example.videorecorder.songstudio.util.Base64.decode(data));
		}
