...
import com.example.videorecorder.songstudio.recording.camera.preview.ChangbaRecordingPreviewView;
import com.example.videorecorder.songstudio.recording.camera.preview.ChangbaVideoCamera;
...
import com.example.videorecorder.songstudio.recording.video.CommonVideoRecordingStudio;
import com.example.videorecorder.songstudio.recording.video.VideoRecordingStudio;
import com.example.videorecorder.songstudio.recording.video.VideoRecordingStudio.RecordingStudioStateCallback;

import com.example.videorecorder.utils.FilePathUtil;
import com.example.videorecorder.utils.StringUtil;
...
//		startActivity(intent);
    ...
    private void preProcess() {
        // 保持屏幕长亮
//        wakeLock = ((PowerManager) getSystemService(Context.POWER_SERVICE)).newWakeLock(PowerManager.FULL_WAKE_LOCK, "app:RecordActivity");
//        wakeLock.acquire();
