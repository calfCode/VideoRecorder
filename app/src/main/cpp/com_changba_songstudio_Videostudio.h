 ...
 * Signature: (Ljava/lang/String;IIIIIIILcom/example/videorecorder/songstudio/audioeffect/AudioEffect;)I
 */
JNIEXPORT jint JNICALL Java_com_example_videorecorder_songstudio_Videostudio_startCommonVideoRecord
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_example_videorecorder_songstudio_Videostudio_stopVideoRecord
  (JNIEnv *, jobject);
