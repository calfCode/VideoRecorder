...
JNIEXPORT void JNICALL Java_com_example_videorecorder_songstudio_recording_camera_preview_ChangbaRecordingPreviewScheduler_setBeautifyParam(JNIEnv* env, jobject, jint, jfloat);
