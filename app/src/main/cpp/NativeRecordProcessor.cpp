...
JNIEXPORT jint JNICALL Java_com_example_videorecorder_songstudio_recorder_NativeRecordProcessor_init(JNIEnv * env, jobject obj,
...
JNIEXPORT jint JNICALL Java_com_example_videorecorder_songstudio_recorder_NativeRecordProcessor_pushAudioBufferToQueue(JNIEnv * env, jobject obj, jint index, jshortArray audioSamples,
